...
export async function render(page) {
    ...
    for (let el in elements) {
        ...
        if (targetNode == null) {
            throw TypeError(`HTML template must include an element with the id "${el}".`);
        }
 ...
 */
export function buildHeadTags(doc, data) {
    let tags = [];
 ...
 */
function createDocument(htmlTemplate, cssFile) {
